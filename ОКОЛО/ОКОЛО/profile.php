    ...
    <main class="container profile-container">
        ...
        <div class="profile-card">
            ...
            <div id="tab-main" class="tab-content active">
                <h2 style="margin-bottom: 1.5rem; color: #1e3c72;">Личная информация</h2>
            ...
            <div id="tab-medical" class="tab-content">
                <div class="medical-card">
                    ...
                    <div style="background: #e8f0fe; padding: 1.5rem; border-radius: 10px; margin-bottom: 2rem;">
                        <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap;">
                            ...
                            <h4 style="color: #1e3c72; margin: 0;"><?php echo htmlspecialchars($patient_data['diagnosis_name']); ?></h4>
                        </div>
                ...
                <form method="POST" class="profile-card" style="margin-top: 1rem;">
                    <h3 style="margin-bottom: 1.5rem; color: #1e3c72;">Редактировать медицинские данные</h3>
            ...
            <div id="tab-documents" class="tab-content">
                <div class="medical-card">
                    ...
                    <!-- Интеграция с ЕМИАС (заглушка) -->
                    <div class="emias-integration" style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%);">
                        <div class="emias-status">
                            <span class="dot"></span>
            ...
            <div id="tab-history" class="tab-content">
                <h2 style="margin-bottom: 1.5rem; color: #1e3c72;">История операций</h2>
                ...
                <div class="medical-card" style="text-align: center;">
                    <p style="color: #666;">История операций отсутствует</p>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div id="tab-patients" class="tab-content">
                <h2 style="margin-bottom: 1.5rem; color: #1e3c72;">Список пациентов с МКБ-10</h2>
            ...
            <div id="tab-schedule" class="tab-content">
                <h2 style="margin-bottom: 1.5rem; color: #1e3c72;">График операций</h2>
            ...
            <div id="tab-stats" class="tab-content">
                <h2 style="margin-bottom: 1.5rem; color: #1e3c72;">Статистика работы</h2>
            ...
            <div id="tab-settings" class="tab-content">
                <div class="profile-card" style="margin-bottom: 1rem;">
                    <h3 style="margin-bottom: 1.5rem; color: #1e3c72;">Редактировать профиль</h3>
                ...
                <div class="profile-card">
                    <h3 style="margin-bottom: 1.5rem; color: #1e3c72;">Изменить пароль</h3>
